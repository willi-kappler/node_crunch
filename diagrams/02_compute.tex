...
\begin{tikzpicture}
    ...
    % \draw [action_step] (connect2) -- node {} ++(0, -0.75) -- node {} ++(3, 0) |- (loop);
    ...
    % \draw [action_step] (prepare) -- node {} ++(0, -0.75) -- node {} ++(-3, 0) |- (wait);
    ...
    % \draw [action_step] (server_process) -- node {} ++(0, -0.75) -- node {} ++(-3.5, 0) |- (wait);
